...
$valor = number_format($produto->getPreco() * $itemCart['qtd'], 2, ",", ".");

// Inserir os dados no banco de dados
$sql = "INSERT INTO compra (descricao, valor, imposto) VALUES ('$jsonCart', '$valor', 'imposto')";


// Fechar a conexão com o banco de dados
mysqli_close($conn);
header("location:http://localhost/PrecodeShop/");
}
